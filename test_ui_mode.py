...
class UiModeTests(unittest.TestCase):
    ...
    def test_minimum_window_keeps_primary_sections_visible(self):
        ...
        try:
            ...
            self.assertEqual(style.lookup("Accent.TButton", "foreground"), APP.SURFACE)
            self.assertEqual(style.lookup("Accent.TButton", "bordercolor", ("focus",)), APP.ACCENT)
            self.assertEqual(style.lookup("Danger.TButton", "bordercolor", ("focus",)), APP.ACCENT)
            ...
            self.assertEqual(gui.output_file_label.cget("style"), "CardTechnical.TLabel")
